...
{ \
    ...
    {ERROR_TDNF_CACHE_OUT_OF_MEMORY, "ERROR_TDNF_CACHE_OUT_OF_MEMORY", "Insufficient disk space at cache directory /var/cache/tdnf (unless specified differently in config). Try freeing space first!"},\
